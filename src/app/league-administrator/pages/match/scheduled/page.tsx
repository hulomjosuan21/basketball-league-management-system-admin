    ...
    const header = (
        <header className="sticky top-0 z-10 bg-background border-b flex items-center gap-2 py-1">
            <div className="flex w-full items-center gap-1 px-4 lg:gap-2 lg:px-6">
                ...
                <h1 className="text-base font-medium">Scheduled</h1>
            </div>
        </header>
    )
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {data.length > 0 ? (
                                                    ...
                                                    <div className="flex flex-col" key={item.stage_id}>
                                                        ...
                                                        {leagueMeta?.has_league && (
                                                            <code className="bg-muted relative rounded px-[0.3rem] py-[0.2rem] font-mono text-xs w-fit">
                                                                @league/{leagueMeta.league_meta?.league_title}/divisions/{category.category_name}/scheduled/round/{item.category}
                                                            </code>
                                                        )}
                                                ...
                                                <div className="text-muted-foreground italic">No scheduled match for this category.</div>
                                            )}
                                        </TabsContent>
                                    )
                                })}
